  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Arts, Computer Science}{}
          \resumeItemListStart
            \resumeItem{GPA: 3.968}
            \resumeItem{Relevant Coursework: Data Structures, Discrete Math, Computer Organization, Data Science}
...
\section{Activities and Interests}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{ASIA}{: Member of the ASIA club on campus to promote asian culture} \\
     \textbf{Ultimate Frisbee}{: Member of the ultimate frisbee club} \\
     \textbf{Robotics}{: Founding member of the robotics club} \\
     \textbf{MOCA}{: Member of the men of color alliance} \\
     \textbf{Kriya Frisbee}{: We used ultimate frisbee as a medium to bridge the gender gap in rural India} \\
    }}
 \end{itemize}
