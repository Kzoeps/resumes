...
\resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Maintained and developed features for a vendor booking platform using ReactJS on top of legacy code.}
        ...
        \resumeItem{End to end delivery from requirement gathering, testing, deployment on netlify and maintenance.}
...
\resumeProjectHeading
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            % \resumeItem{Built a test preparation web application, using ReactJS and Firestore, for the Bhutanese exams with a growing user count of 580+.}
